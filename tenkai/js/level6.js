...
Vue.createApp({
    ...
    methods: {
        ...
        tsugi() {
            if (this.run_flg && this.timer_flg) {
                ...
                if (this.a == this.c && this.b == this.d) {
                    this.mondai = '('+  (this.a==1?'':this.a)+ 'x' + (this.b>=0?'+':'') + this.b + ')²';
                } else {
                    this.mondai = '(' +(this.a==1?'':this.a) +'x' + (this.b>=0?'+':'') + this.b + ')('+(this.c==1?'':this.c)+'x' + (this.d>=0?'+':'') + this.d + ')';
                }
            }
        ...
        center(n) {
            ...
            if(this.num2>0){ this.show_num2 = '+' + this.num2 + 'x'; }
            if(this.num2<0){ this.show_num2 = this.num2 + 'x'; }
            if(this.num2==0){ this.show_num2 = ''; }
            if(this.num2==1){ this.show_num2 = '+x'; }
            if(this.num2==-1){ this.show_num2 = '-x'; }
        },
        ...
        num2_C: function () { this.num2 = 0; this.num2_plus='+';this.show_num2='';},
