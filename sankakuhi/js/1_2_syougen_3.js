    ...
    data() {
        return {
            ...
            kotae: [
                ...
                'img/n_0.png',
                'img/n_2_bunno_1.png',
                'img/n_r2_bunno_1.png',
                'img/n_2_bunno_r3.png',
                'img/n_1.png',
                'img/n_2_bunno_r3.png',
                'img/n_r2_bunno_1.png',
                'img/n_2_bunno_1.png',
                ...
                'img/n_2_bunno_1.png',
                'img/n_0.png',
                'img/n_mainasu_2_bunno_1.png',
                'img/n_mainasu_r2_bunno_1.png',
                'img/n_mainasu_2_bunno_r3.png',
                'img/n_mainasu_1.png',
                'img/n_0.png',
                'img/n_r3_bunno_1.png',
                'img/n_1.png',
                'img/n_r3.png',
                'img/batsu.png',
                'img/n_mainasu_r3.png',
                'img/n_mainasu_1.png',
                'img/n_mainasu_r3_bunno_1.png',
                'img/n_0.png',
            ],
            user: [
                'img/question.png',
    ...
    methods: {
        ...
        tsugi() {
            if (this.run_flg && this.timer_flg) {
                this.hantei_flg = false;
                this.user_num = 0;
                if (this.seikai_flg == true) {
                    this.mondai_num++;
                }
                if (this.mondai_num > 27) {
                    this.stop();
                }
            }
